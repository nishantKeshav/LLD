...
public class CashfreeIntegrationClient implements IntegrationClient {
    ...
    public IntegrationProvider getProvider() {
        return IntegrationProvider.CASHFREE;
    }
    ...
    public Set<IntegrationOperation> supportedOperations() {
        return Set.of(IntegrationOperation.PAYMENT, IntegrationOperation.PAYOUT);
    }
