...
public class PaypalIntegrationClient  implements IntegrationClient {
    ...
    public IntegrationProvider getProvider() {
        return IntegrationProvider.PAYPAL;
    }
    ...
    public Set<IntegrationOperation> supportedOperations() {
        return Set.of(IntegrationOperation.PAYMENT, IntegrationOperation.REFUND);
    }
